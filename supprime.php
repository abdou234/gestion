...
<?php
    ...
    $id=$_GET['id'];
    $sql = "SELECT * FROM ndiaye where id='$id'";
                   ...
                   <div class="row">
                       <div class="col-md-12" style="box-shadow: 0px 0px 4px 4px rgba(0.1,0.1,0.1,0.1); padding:20px">
                           <div class="card strpied-tabled-with-hover">
                               <div class="card-header "style=" color: rgb(85, 81, 104);">
                                   <h4 class="card-title" > Recapitulatif du rendez-vous</h4>
                               </div>
